...
export declare class BackTrackingParser extends EmbeddedActionsParser {
    constructor();
    statement: (idxInCallingRule?: number | undefined, ...args: any[]) => RET_TYPE;
    withEqualsStatement: (idxInCallingRule?: number | undefined, ...args: any[]) => RET_TYPE;
    withDefaultStatement: (idxInCallingRule?: number | undefined, ...args: any[]) => RET_TYPE;
    qualifiedName: (idxInCallingRule?: number | undefined, ...args: any[]) => RET_TYPE;
